...
class KFShellService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_START_BACKGROUND_RUNTIME =
            "com.kftest.app.foundation.service.action.START_BACKGROUND_RUNTIME"
        private const val ACTION_STOP_BACKGROUND_RUNTIME =
            "com.kftest.app.foundation.service.action.STOP_BACKGROUND_RUNTIME"
        private const val ACTION_RESTART_BACKGROUND_RUNTIME =
            "com.kftest.app.foundation.service.action.RESTART_BACKGROUND_RUNTIME"
        private const val ACTION_CREATE_SHELL_SESSION =
            "com.kftest.app.foundation.service.action.CREATE_SHELL_SESSION"
        private const val ACTION_LAUNCH_AGENT_SESSION =
            "com.kftest.app.foundation.service.action.LAUNCH_AGENT_SESSION"
        private const val ACTION_SEND_TERMINAL_COMMAND =
            "com.kftest.app.foundation.service.action.SEND_TERMINAL_COMMAND"
        private const val ACTION_PASTE_TERMINAL_INPUT =
            "com.kftest.app.foundation.service.action.PASTE_TERMINAL_INPUT"
        private const val ACTION_END_TERMINAL_SESSION =
            "com.kftest.app.foundation.service.action.END_TERMINAL_SESSION"
        private const val ACTION_REFRESH_RUNTIME_OVERVIEW =
            "com.kftest.app.foundation.service.action.REFRESH_RUNTIME_OVERVIEW"
        ...
        when (intent?.action) {
            ACTION_CREATE_SHELL_SESSION -> {
                serviceScope.launch {
                    ...
                    com.kftest.app.foundation.terminal.TerminalRuntimeHost.createShellSession(appContext)
                }
            }
            ...
            ACTION_LAUNCH_AGENT_SESSION -> {
                ...
                if (agentRuntimeId.isNotBlank()) {
                    serviceScope.launch {
                        initJob.join()
                        ensureOperationalState(appContext)
                        com.kftest.app.foundation.terminal.TerminalRuntimeHost.launchAgentSession(appContext, agentRuntimeId)
                    }
                }
            }
            ...
            ACTION_SEND_TERMINAL_COMMAND -> {
                ...
                if (command.isNotBlank()) {
                    serviceScope.launch {
                        ...
                        com.kftest.app.foundation.terminal.TerminalRuntimeHost.sendCommand(
            ...
            ACTION_END_TERMINAL_SESSION -> {
                ...
                serviceScope.launch {
                    initJob.join()
                    ensureOperationalState(appContext)
                    com.kftest.app.foundation.terminal.TerminalRuntimeHost.endSession(
                        appContext,
                        sessionId
                    )
                }
            ...
            ACTION_PASTE_TERMINAL_INPUT -> {
                ...
                if (payload.isNotEmpty()) {
                    serviceScope.launch {
                        initJob.join()
                        ensureOperationalState(appContext)
                        com.kftest.app.foundation.terminal.TerminalRuntimeHost.pasteMultiline(
                            appContext,
                            payload
                        )
                    }
