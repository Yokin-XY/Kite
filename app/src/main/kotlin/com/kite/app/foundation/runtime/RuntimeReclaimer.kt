...
object RuntimeReclaimer {
    ...
    fun reclaimRegisteredRuntime(
        ...
        val decision = RuntimeStopDecision(
            runtimeId = runtimeId,
            title = title,
            retentionClass = com.kite.app.foundation.service.RuntimeRetentionClass.EPHEMERAL,
            reclaimPriority = com.kite.app.foundation.service.RuntimeRetentionClass.EPHEMERAL.reclaimPriority,
            rssKb = 0L,
    ...
    private fun RuntimeRootSnapshot.isReclaimableUnder(
        ...
        return when (ownerKind) {
            RuntimeRootOwnerKind.BACKGROUND_RUNTIME -> when (retentionClass) {
                com.kite.app.foundation.service.RuntimeRetentionClass.EPHEMERAL -> !ownerId.isNullOrBlank()
                com.kite.app.foundation.service.RuntimeRetentionClass.BATCH ->
    ...
    private fun RuntimeRootSnapshot.isReclaimableByLifecyclePlan(
        ...
        return when (ownerKind) {
            RuntimeRootOwnerKind.BACKGROUND_RUNTIME -> when (retentionClass) {
                com.kite.app.foundation.service.RuntimeRetentionClass.EPHEMERAL ->
                    !ownerId.isNullOrBlank()
                com.kite.app.foundation.service.RuntimeRetentionClass.BATCH ->
                    !ownerId.isNullOrBlank() &&
    ...
    private sealed interface RuntimeReclaimDecision {
        val title: String
        val retentionClass: com.kite.app.foundation.service.RuntimeRetentionClass
    ...
    private data class RuntimeStopDecision(
        ...
        override val retentionClass: com.kite.app.foundation.service.RuntimeRetentionClass,
