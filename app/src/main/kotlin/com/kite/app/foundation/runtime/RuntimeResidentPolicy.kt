...
object RuntimeResidentPolicyStore {
    ...
    fun evaluate(
        ...
        val defaultAutoStart = when {
            record.retentionClass == com.kite.app.foundation.service.RuntimeRetentionClass.CRITICAL_CORE -> true
        ...
        val allowAutoStart = if (record.retentionClass ==
            com.kite.app.foundation.service.RuntimeRetentionClass.CRITICAL_CORE
        ) {
            true
        } else {
