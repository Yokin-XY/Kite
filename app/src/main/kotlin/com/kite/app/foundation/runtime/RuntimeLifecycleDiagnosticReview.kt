...
object RuntimeLifecycleDiagnosticReview {
    ...
    private fun blockingIssuesFor(
        ...
        if (root?.runtimeKind == com.kite.app.foundation.service.BackgroundRuntimeKind.CONTAINER_SUPERVISOR &&
            tier != RuntimeLifecycleAuthorityTier.SYSTEM_CORE
        ) {
            issues += "system_core_downgraded_by_non_core_authority"
        }
        if (root?.runtimeKind == com.kite.app.foundation.service.BackgroundRuntimeKind.PROOT_CAPACITY_WORKER &&
