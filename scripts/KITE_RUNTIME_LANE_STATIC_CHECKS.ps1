...
Assert-True ($prootOwnerTerminator -match 'kf_kill_groups' -and $prootOwnerTerminator -match 'kf_kill_pids' -and $prootOwnerTerminator -match 'kill -KILL') 'owner stop must kill Ubuntu process groups first, then individual tracee pids.'
